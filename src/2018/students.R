...
write_csv(problems, 'build/2018/problems/flags/students.csv')
...
write_parquet(processed, "build/2018/students.parquet",
              compression = "zstd", compression_level = 10
)

write_parquet(flags, "build/2018/flags/students.parquet",
              compression = "zstd", compression_level = 10
)
