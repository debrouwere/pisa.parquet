...
write_csv(problems, 'build/2009/problems/flags/students.csv')
...
write_parquet(processed, "build/2009/students.parquet",
              compression = "zstd", compression_level = 10
)

write_parquet(flags, "build/2009/flags/students.parquet",
              compression = "zstd", compression_level = 10
)
